...
robots
  ...
  comenzar
    ...
    juntarFlores(cantF)
    {entro en conflicto}
    bloquearAvisaLiberarVertical(cantF,id)
    {meFalta:= 60 - (cantMoverme+1)}
  ...
  comenzar
    ...
    Informar('hola',PosAv)
    repetir 53 {57+3=60 Nose por que es 53...}
      juntarFlores(cantF)
      mover
    juntarFlores(cantF)
    RecibirMensaje(ok,jefe)
