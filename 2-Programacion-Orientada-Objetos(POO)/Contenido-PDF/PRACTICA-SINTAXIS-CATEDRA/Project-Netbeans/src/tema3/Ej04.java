...
public class Ej04 {
    ...
    public static void main(String[] args){
        ...
        for (i=0; i<nro; i++){
            ...
            nuevoHotel.cargarCliente(C,GeneradorAleatorio.generarInt(nro));
        }
        
        System.out.println(nuevoHotel.toString());
        
        
        System.out.println("Ingrese aumento de costo para las habitaciones");
        double aumento = Lector.leerDouble();
        nuevoHotel.aumentarPrecio(aumento);
