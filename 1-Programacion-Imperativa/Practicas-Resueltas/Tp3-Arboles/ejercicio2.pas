...
//code Final Compilado y testeado
program ejercicio2;
...
function informarCantUniVendidaSinOcurrencias(a1: arbolMismoCod;codBuscado1,cantVendida1: integer):integer;
begin
	if(a1 = nil) or (cantVendida1 > 0)then
		informarCantUniVendidaSinOcurrencias:= cantVendida1
	else
		begin
			if(codBuscado1 = a1^.dato.codProducto)then
				cantVendida1:= a1^.dato.cantVendida;
			if(codBuscado1 < a1^.dato.codProducto)then
				informarCantUniVendidaSinOcurrencias:= informarCantUniVendidaSinOcurrencias(a1^.hi,codBuscado1,cantVendida1)
			else
				informarCantUniVendidaSinOcurrencias:= informarCantUniVendidaSinOcurrencias(a1^.hd,codBuscado1,cantVendida1);
		end;
end;
...
begin	
  ...
  cantVendida1:= 0;
  Writeln('La cantidad vendida es: ',informarCantUniVendidaSinOcurrencias(a1,codBuscado0,cantVendida1), ' usando el arbol sin ocurrencias');
end.
